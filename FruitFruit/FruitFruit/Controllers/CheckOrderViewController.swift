...
//        self.navigationController?.navigationBar.shadowImage = nil
    ...
    private func setTitleLabelUI(_ tintedText: String, _ tintColor: UIColor) {
    ...
    private func setSecondaryTextTime(_ timeInTwentyFourHour: Int) -> String {
    ...
    private func setSecondaryTextPlace(_ place: String) -> String {
        return place
    }
